...
// The health check and Clerk's own sign-in/sign-up pages stay public to auth.protect() (a
// protected sign-in page can never be reached — protecting it causes an infinite
// auth.protect() -> redirect-to-sign-in -> auth.protect() loop, ERR_TOO_MANY_REDIRECTS);
// everything else requires sign-in. See plan/PHASE_3_PLAN.md section 4.2.
//
